...
signal money_changed(total_money)
signal mission_text_changed(text)
signal vehicle_status_changed(text)
...
func raise_money_changed(total_money: int) -> void:
	emit_signal("money_changed", total_money)

func raise_mission_text_changed(text: String) -> void:
	emit_signal("mission_text_changed", text)

func raise_vehicle_status_changed(text: String) -> void:
	emit_signal("vehicle_status_changed", text)
